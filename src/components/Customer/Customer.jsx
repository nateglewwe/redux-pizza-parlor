...
export default function Customer() {
    ...
    return (
        ...
        <form  onSubmit={handleSubmit}>
            ...
            <input type="radio" id="pickup" name="order_type" value="Pickup" checked={formData.orderType === 'Pickup'} onChange={handleOrderTypeChange}></input>
            <label htmlFor="pickup">Pickup</label><br></br>
            <input type="radio" id="delivery" name="order_type" value="Delivery" checked={formData.orderType === 'Delivery'} onChange={handleOrderTypeChange}></input>
